...
while(k <= N){
  ...
  if(ltrt !=3 | lctrl != 3){
    ...
    #AOW estimation with mis-specified
...
res1
final_res = res1
write.csv(final_res,file="C:/Users/82655/Dropbox/research/covariate adjustment win ratio/simu_res_int/aow_mis_b_300.csv")  
